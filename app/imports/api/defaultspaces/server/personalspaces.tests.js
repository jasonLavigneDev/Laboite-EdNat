...
//       });
//     });
//     describe('DefaultSpaces.self', function () {
//       it('sends current user personalspace', function (done) {
//         const collector = new PublicationCollector({ userId });
//         collector.collect('DefaultSpaces.self', (collections) => {
...
//         const ps = DefaultSpaces.findOne({ userId });
...
//         const psafter = DefaultSpaces.findOne({ userId });
...
//           },
//           Meteor.Error,
//           /api.DefaultSpaces.backToDefaultElement.notPermitted/,
//         );
//       });
...
//           },
//           Meteor.Error,
//           /api.DefaultSpaces.backToDefaultElement.unknownType/,
//         );
//       });
//     });
//   });
