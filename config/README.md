...
| disabledFeatures.analytics                     | boolean  | false                                | disable analytics                                                                           |
| disabledFeatures.introductionTab               | boolean  | false                                | disable introduction tab                                                                    |
| disabledFeatures.introductionTabStructureInfos | boolean  | false                                | disable structures informations tab                                                         |
| disabledFeatures.menuAdminDefaultSpaces        | boolean  | true                                 | Hide default space functionnality witch doesn't work                                        |
| disabledFeatures.mediaStorageMenu              | boolean  | false                                | disable media storage menu                                                                  |
| disabledFeatures.bookmarksFromClipboard        | boolean  | false                                | disable clipboard scan for auto bookmark import                                             |
| ui.defaultGridViewMode                         | string   | list                                 | "compact" or "detail" for view mod in groups or service page                                |
| ui.isBusinessRegroupingMode                    | boolean  | false                                | disable business regrouping for services                                                    |
| ui.feedbackLink                                | string   | ""                                   |
...
| onBoarding                                     | object   | {}                                   | option for on boarding                                                                      |
| onBoarding.enabled                             | boolean  | true                                 | enable on boarding                                                                          |
| onBoarding.appDesignation                      | string   | ""                                   |                                                                                             |
| countly                                        | object   | {}                                   |                                                                                             |
...
| endpoint | string | ""            | france transfert endpoint |
